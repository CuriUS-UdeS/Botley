...
Serial.print("Testing line on white: ");
...
Serial.println("white testing finished ");
Serial.println();
delay (5000);


Serial.println("testing line on Green: ");
Calibrate_Line_Sensor(FollowLine.Manuel, 1);
for (int i = 0; i<400; i++){  
  test = ImIOnLine ();
  if (test == 1) {
...
Serial.println();
Serial.println("green testing finished ");

delay(5000);
Serial.print("testing line on Yellow: ");
...
Serial.println("yellow testing finished ");
